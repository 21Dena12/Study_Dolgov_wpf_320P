...
namespace Study_Kamalov_wpf_320P.Pages
{
    public partial class DisciplinesPage : Page
    {
        ...
        {
            var disciplines = ConnectionHelper.db.Disciplina
        ...
        private void SearchBox_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            var filtered = ConnectionHelper.db.Disciplina
        ...
        {
            var selectedDiscipline = DisciplinesGrid.SelectedItem as Disciplina;
            ...
            if (selectedDiscipline != null)
            {
                ...
                if (result == MessageBoxResult.Yes)
                {
                    try
                    {
                        ...
                        ConnectionHelper.db.Disciplina.Remove(selectedDiscipline);
